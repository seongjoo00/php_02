...
<body>
    <form action="edit_ok.php" name="join_form" method="post">
        <fieldset>
            <legend>정보수정</legend>
                ...
                <p>
                    아이디
                    <?php echo $array["uid"]?>
                    <input type="hidden" name="uid" id="uid" value="<?php echo $array["uid"]?>">
                </p>
                ...
                <button type="button" onclick="del_id()">회원탈퇴</button>
